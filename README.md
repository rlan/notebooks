...
| --------------------- | ------- | ---------- | ---- |
| `pytorch2.2.0` | CPU-only | [Dockerfile](docker/pytorch2.2.0/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/pytorch2.2.0) |
| `pytorch2.2.0-cuda12.1` | Nvidia Driver >= 525.60.13 (Linux) 527.41 (Windows) | [Dockerfile](docker/pytorch2.2.0-cuda12.1/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/pytorch2.2.0-cuda12.1) |
| `pytorch2.2.0-cuda11.8` | Nvidia Driver >= 450.80.02 (Linux) 452.39 (Windows) | [Dockerfile](docker/pytorch2.2.0-cuda11.8/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/pytorch2.2.0-cuda11.8) |
