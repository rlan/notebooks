...
| Tag (OS-based python) | Comment | Dockerfile | Info |
| --------------------- | ------- | ---------- | ---- |
| `tf2.10.0` | CPU-only | [Dockerfile](docker/tf2.10.0/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/tf2.10.0) |
| `tf2.10.0-cuda11.2` | Nvidia Driver >= 450.80.02 (Linux) 452.39 (Windows) | [Dockerfile](docker/tf2.10.0-cuda11.2/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/tf2.10.0-cuda11.2) |
