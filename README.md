...
| Tag (OS-based python) | Comment | Dockerfile | Info |
| --------------------- | ------- | ---------- | ---- |
| `tf2.13.0` | CPU-only | [Dockerfile](docker/tf2.13.0/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/tf2.13.0) |
| `tf2.13.0-cuda11.8` | Nvidia Driver >= 450.80.02 (Linux) 452.39 (Windows) | [Dockerfile](docker/tf2.13.0-cuda11.8/Dockerfile) | ![](https://img.shields.io/docker/image-size/wqael/notebooks/tf2.13.0-cuda11.8) |
