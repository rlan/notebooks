...
LABEL description="PyTorch / Python 3 / nvidia/cuda:8.0-cudnn7-runtime-ubuntu16.04" \
...
RUN ${PIP} --no-cache-dir install -q --upgrade \
      https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp35-cp35m-linux_x86_64.whl \
